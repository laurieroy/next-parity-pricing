  ...
  return (
    <>
      <section className="min-h-screen bg-[radial-gradient(hsl(0,72%,65%,40%),hsl(24,62%,73%,40%),hsl(var(--background))_60%)] flex items-center justify-center text-center text-balance flex-col gap-8 px-4">
        <h1 className="text-6xl lg:text-7xl xl:text-6xl font-bold tracking-tight m-4 capitalize">
      ...
      <section id="pricing" className="px-8 py-16 bg-accent/5">
        <h2 className="text-4xl text-center text-balance font-semibold mb-8">
          Pricing software that pays for itself 20x over
        </h2>
  ...
  return (
    <Card>
      ...
      <CardContent className="">
        <SignUpButton>
          <Button
            className="text-lg w-full rounded-lg capitalize"
      ...
      <CardFooter className="flex flex-col gap-4 items-start">
        <Feature className="font-bold">
          {maxNumberOfProducts}{" "}
          {maxNumberOfProducts === 1 ? "products" : "products"}
        </Feature>
